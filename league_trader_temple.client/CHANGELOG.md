...
- Create Angular project with ng: `ng new league_trader_temple.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`league_trader_temple.client.esproj`).
